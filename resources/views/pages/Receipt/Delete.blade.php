...
<div class="modal fade" id="Delete_receipt{{ $student_receipt->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('student_receipts.destroy', 'test') }}" method="post">
                    @csrf
                    @method('DELETE')
