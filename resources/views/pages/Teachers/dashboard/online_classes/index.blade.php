            ...
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            {{--  --}}
                            <a href="{{ route('teacher.online_class.create') }}" class="btn btn-success" role="button"
                                aria-pressed="true">اضافة حصة اونلاين جديدة</a>
                            {{--  --}}
                            <a class="btn btn-warning" href="{{ route('teacher.online_class.indirect_create') }}">اضافة
                                حصة اوفلاين
                                جديدة</a>
