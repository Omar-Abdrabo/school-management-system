...
return new class extends Migration
{
    ...
    {
        Schema::create('student_accountents', function (Blueprint $table) {
            $table->id();
            $table->foreignId('student_id')->constrained('students')->cascadeOnDelete();
            $table->foreignId('fee_invoice_id')->nullable()->constrained('fee_invoices')->cascadeOnDelete();
            $table->foreignId('receipt_id')->nullable()->constrained('student_receipts')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('student_accountents');
    }
};
